        ...
        <template v-if="!isModelScope">
          <div class="config-section">
            ...
            <div class="cfg-help">
              ...
              <p>1. 访问 <a href="https://xingyun3d.com/?utm_campaign=github&utm_source=shequ&utm_medium=&utm_term=&utm_content=" target="_blank">魔珐星云官网</a> 注册账号</p>
              <p>2. 注册时填入邀请码 <b class="invite-code">JSNAHT5QFM</b>（可获 1000 积分）</p>
